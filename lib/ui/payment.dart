            ...
            Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: TextField(
                      decoration: const InputDecoration(border: UnderlineInputBorder(), hintText: 'Credit Card'),
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      decoration: const InputDecoration(border: UnderlineInputBorder(), hintText: 'Expiration Date'),
              ...
              child: Row(
                children: [
                  Expanded(
                    child: TextField(
                      keyboardType: TextInputType.number,
                      decoration: const InputDecoration(border: UnderlineInputBorder(), hintText: 'CVC'),
